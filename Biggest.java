//create a class biggest that contains a single dimensional array as data member and a method display() to find and display the largest element of the array
class Biggest {
